<template>
  <div class="tags-container" id="tags-container">
    ...
    >
      ...
      >
        ...
        <i-ep-close
          class="close-icon"
          size="12px"
          v-if="!isAffix(tag) && !isOnlyOneView()"
    ...
    >
      ...
      <li v-if="!isAffix(selectedTag) && !isOnlyOneView()" @click="closeSelectedTag(selectedTag)">
        <svg-icon icon-class="close" />
        关闭
      </li>
      <li v-if='!isOnlyOneView() && !isFirstView()' @click="closeOtherTags">
      ...
      <!-- <li v-if='!isOnlyOneView()' @click="closeAllTags(selectedTag)">
...
function isFirstView() {
  try {
    return (
      selectedTag.value.fullPath === tagsViewStore.visitedViews[0].fullPath
    );
  } catch (err) {
    return false;
  }
